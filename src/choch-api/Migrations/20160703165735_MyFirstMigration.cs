...
namespace chochapi.Migrations
{
    public partial class MyFirstMigration : Migration
    {
        ...
        {
            migrationBuilder.CreateTable("Provider", table => new
            {
            ...
            migrationBuilder.CreateTable("AspNetUsers", table => new
            {
                ...
                ActiveProviderProviderId = table.Column<int>(nullable: true),
                ConcurrencyStamp = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey("FK_AspNetUsers_Provider_ActiveProviderProviderId", x => x.ActiveProviderProviderId,
                        "Provider", "ProviderId",
            ...
            migrationBuilder.CreateIndex("IX_AspNetUsers_ActiveProviderProviderId", "AspNetUsers",
                "ActiveProviderProviderId");
            ...
            migrationBuilder.CreateIndex("IX_AspNetUserRoles_UserId", "AspNetUserRoles", "UserId");
        }
